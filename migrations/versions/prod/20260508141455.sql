...
CREATE TABLE "public"."ai_detect_result_models" (
  ...
  CONSTRAINT "fk_article_applications_ai_detect_results" FOREIGN KEY ("application_id") REFERENCES "public"."article_applications" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT "fk_review_stages_ai_detect_results" FOREIGN KEY ("review_stage_id") REFERENCES "public"."review_stages" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE "public"."clients" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_clients_journal" FOREIGN KEY ("journal_id") REFERENCES "public"."journals" ("id") ON UPDATE NO ACTION ON DELETE SET NULL
);
