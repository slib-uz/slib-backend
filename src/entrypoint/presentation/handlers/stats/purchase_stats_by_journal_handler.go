...
type PurchaseStatsByJournalHandler struct {
	uc *ArticlePurchaseStatsUseCase
}

// @inject
func NewPurchaseStatsByJournalHandler(uc *ArticlePurchaseStatsUseCase) *PurchaseStatsByJournalHandler {
	return &PurchaseStatsByJournalHandler{uc: uc}
}
...
// @Success 200 {array} entity.JournalArticlePurchaseStatsWithNameEntity
// @Router /stats/purchase [get]
func (this *PurchaseStatsByJournalHandler) Handle(ctx echo.Context) error {
